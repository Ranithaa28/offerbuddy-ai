...
export default function LandingPage({ onNavigate, onStartAuth }: LandingPageProps) {
  ...
  const [companyResult, setCompanyResult] = useState<any>(() => {
    ...
    return {
      name: "Zoho",
      rating: 4,
      description: "The bootstrapping champion of South India. Beautiful, lush green organic farms, humble environment, and great software stack built entirely from scratch. 🌴",
      pros: ["Extremely chill culture, minimal corporate stress", "Massive tech stack breadth (build your own databases!)", "Super cool workspaces in Chennai & Tenkasi"],
      cons: ["Compensation is modest compared to US FAANG tier", "A bit siloed in proprietary Zoho tools", "Limited remote-first setups"],
      salary: "₹6,50,000 - ₹11,00,000",
      cultureTags: ["#BootstrappedEmpire", "#TenkasiVibes", "#HumbleCreators", "#FreeLunchAlways"]
    };
  });
  ...
  return (
    <div className="min-h-screen bg-[#FBFBFD] text-slate-800 flex flex-col selection:bg-blue-100 selection:text-blue-900">
      {/* Navbar */}
      <header id="landing-header" className="sticky top-0 z-50 backdrop-blur-md bg-white/80 border-b border-slate-200/80 px-6 py-4">
      ...
      {/* Hero Section */}
      <section id="hero-section" className="relative pt-20 pb-24 overflow-hidden px-6 bg-gradient-to-b from-blue-50/50 via-white to-[#FBFBFD]">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          <h1 className="text-4xl sm:text-6xl font-extrabold tracking-tight text-slate-900 max-w-4xl mx-auto leading-tight mb-6">
            One Platform. <br />
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
            ...
            <a 
              href="#features" 
              className="w-full sm:w-auto px-8 py-4 rounded-xl bg-white border border-slate-200 hover:bg-slate-50 text-slate-600 font-semibold text-base transition-colors text-center shadow-sm"
            >
              Explore Experts
            </a>
          </div>
          ...
          <div className="relative mx-auto max-w-4xl border border-slate-100 rounded-3xl bg-white p-3 shadow-xl backdrop-blur-sm">
      ...
      {/* Features Grid */}
      <section id="features" className="py-24 border-t border-slate-100 bg-white px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {/* Feature 1 */}
            <div className="group bg-slate-50 hover:bg-white border border-slate-100 hover:border-slate-200 rounded-3xl p-6 transition-all duration-300 hover:shadow-md">
      ...
      {/* How It Works */}
      <section id="how-it-works" className="py-24 border-t border-slate-100 bg-[#FBFBFD] px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 relative">
            ...
            <div className="bg-white border border-slate-100 rounded-2xl p-6 relative z-10 text-center shadow-sm">
      ...
      <section id="pricing" className="py-24 border-t border-slate-100 bg-white px-6">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-slate-800 mb-4">Simple, Transparent Pricing</h2>
            <p className="text-slate-500">Zero costs. Designed exclusively as a final-year placement aid for all engineering and MCA graduates.</p>
          </div>

          <div className="relative mx-auto max-w-md bg-gradient-to-tr from-blue-50 via-white to-emerald-50 rounded-3xl p-8 border border-slate-100 shadow-lg overflow-hidden">
            ...
            <h3 className="text-xl font-bold text-slate-800 mb-1">Dream Job Plan</h3>
            <p className="text-xs text-slate-500 mb-6">Complete access to all four AI experts with full statistics tracking.</p>
            ...
            <button 
              id="pricing-cta-btn"
              onClick={onStartAuth}
              className="w-full py-3.5 rounded-xl bg-gradient-to-r from-blue-600 to-emerald-500 hover:scale-[1.01] transition-transform text-white font-bold text-sm shadow-md cursor-pointer mb-8"
            >
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3 text-sm text-slate-600">
                <CheckCircle2 className="h-5 w-5 text-emerald-500 shrink-0" />
                <span>Custom role-aligned learning roadmaps</span>
              </div>
              <div className="flex items-center gap-3 text-sm text-slate-600">
                <CheckCircle2 className="h-5 w-5 text-emerald-500 shrink-0" />
                <span>Dynamic mock technical & HR interviews</span>
              </div>
              <div className="flex items-center gap-3 text-sm text-slate-600">
                <CheckCircle2 className="h-5 w-5 text-emerald-500 shrink-0" />
                <span>Algorithmic logic and complexity evaluations</span>
              </div>
              <div className="flex items-center gap-3 text-sm text-slate-600">
                <CheckCircle2 className="h-5 w-5 text-emerald-500 shrink-0" />
                <span>Full placement dashboard tracking</span>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* FAQ Section */}
      <section id="faqs" className="py-24 border-t border-slate-100 bg-[#FBFBFD] px-6">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
          ...
          <div className="space-y-4">
            {faqs.map((faq, idx) => (
              <div 
                key={idx} 
                className="bg-white border border-slate-100 rounded-2xl overflow-hidden shadow-sm transition-colors"
              >
                <button 
                ...
                {activeFaq === idx && (
                  <div className="px-6 pb-6 pt-2 text-slate-600 text-sm border-t border-slate-100 leading-relaxed font-sans">
                    {faq.answer}
                  </div>
                )}
              </div>
      ...
      <section className="py-20 border-t border-slate-100 bg-[#F8FAFC] px-6">
        <div className="max-w-6xl mx-auto">
              ...
              <div>
                ...
                <form onSubmit={handleRoastBullet} className="space-y-3">
                  <textarea
                    ...
                    className="w-full h-24 p-3 border border-slate-200 rounded-2xl text-xs text-slate-800 focus:outline-none focus:border-red-400 font-sans resize-none"
                    required
                  />
                  <button
                    type="submit"
            ...
            <div className="bg-white p-6 sm:p-8 rounded-3xl border border-slate-200/80 shadow-sm flex flex-col justify-between">
              <div>
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h4 className="font-bold text-slate-800 text-base">Company Culture & Salary Vibe Check</h4>
                </div>
                <p className="text-xs text-slate-500 mb-4">
                  Search any tech company to run a live analysis on its culture rating, honest engineering vibes, pros, cons, and estimated starting packages.
                </p>
                ...
                <div className="space-y-4">
                  <form onSubmit={(e) => { e.preventDefault(); handleVibeCheck(); }} className="flex gap-2">
                    <div className="relative flex-1">
                      <input
                        type="text"
                        placeholder="Enter company name, e.g. Amazon, TCS, Microsoft..."
                        value={vibeCompany}
                        onChange={(e) => setVibeCompany(e.target.value)}
                        className="w-full pl-9 pr-3 py-2 border border-slate-200 rounded-xl text-xs text-slate-800 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500"
                ...
                {!vibeLoading && companyResult && (
                  <div className="mt-6 space-y-4 border-t border-dashed border-slate-200 pt-5 animate-fadeIn">
                    <div className="flex justify-between items-center">
                      <span className="text-sm font-black text-slate-800">{companyResult.name} Vibe Check</span>
                    ...
                    <div className="flex flex-wrap gap-1">
                      {companyResult.cultureTags && companyResult.cultureTags.map((tag: string) => (
                        <span key={tag} className="text-[9px] bg-slate-100 text-slate-500 px-2 py-0.5 rounded-full font-mono font-semibold">
                          {tag}
                        </span>
                      ))}
                    </div>
                    ...
                    {/* Salary info */}
                    <div className="bg-indigo-50 border border-indigo-100 rounded-2xl p-3 flex justify-between items-center">
                      <span className="text-[10px] font-bold text-indigo-700 uppercase">Est. Starting Package:</span>
                      <span className="text-xs font-mono font-black text-indigo-900">{companyResult.salary}</span>
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-[11px]">
                      ...
                      <div className="bg-red-50/50 p-3 rounded-xl border border-red-100">
                        <span className="font-bold text-red-800 block mb-1">👎 Cons</span>
                        <ul className="list-disc pl-3.5 space-y-1 text-slate-600">
      ...
      {/* Footer */}
      <footer className="mt-auto border-t border-slate-200/80 bg-white px-6 py-12 text-slate-500 text-xs">
