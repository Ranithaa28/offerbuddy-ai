          ...
          <div className="bg-white border border-slate-100 rounded-3xl p-6 sm:p-8 shadow-sm space-y-6">
              ...
              <div className="space-y-6 animate-in fade-in duration-150">
                ...
                <div className="bg-slate-50 p-4.5 rounded-2xl border border-slate-200/50 flex items-start gap-3 text-slate-600 text-xs leading-relaxed text-left font-sans">
                  ...
                  <div>
                    ...
                    <span>Keep your resume parsing structured into clearly marked sections (e.g., EDUCATION, EXPERIENCE, PROJECTS, SKILLS). Our background analyzer matches these tags against SDE job descriptions.</span>
                  </div>
                </div>
              </div>
            )}
            ...
            <div className="pt-4 flex items-center justify-between gap-4">
              <span className="text-[10px] text-slate-400 font-mono hidden sm:inline">
                SDE Placement Assistant Core v4.1
              </span>
              <button
                type="submit"
                disabled={loading}
